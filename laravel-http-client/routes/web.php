...
//    return $response;
//    $response = Http::get('https://api.qrserver.com/v1/create-qr-code/?data=mokhosh&size=300x300');
...
//    $response = Http::get('https://qrtag.net/api/qr_12.svg?url=https://mokhosh.com');
//    return $response;
...
//    $response = Http::get('https://cdn.jsdelivr.net/gh/fawazahmed0/quran-api@1/editions/ara-quranuthmanihaf/1/1.json'); // https://github.com/fawazahmed0/quran-api
